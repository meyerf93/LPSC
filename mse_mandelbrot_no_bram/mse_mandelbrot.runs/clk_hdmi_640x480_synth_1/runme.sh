...
HD_PWD='/home/joco/Documents/cours/FPGA/master/nexys_video/mse_mandelbrot/mse_mandelbrot.runs/clk_hdmi_640x480_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_hdmi_640x480.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_hdmi_640x480.tcl
